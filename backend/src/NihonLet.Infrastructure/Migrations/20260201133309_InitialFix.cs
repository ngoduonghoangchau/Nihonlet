        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsBulkCreated = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    MasteryPercent = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedDecksJson = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExampleJson = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameJp = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    IconUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReadingCategories", x => x.CatId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxDecks = table.Column<int>(type: "int", nullable: false, defaultValue: 10),
                    AllowBulkCreate = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccuracyPercent = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Reading = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    ExampleTranslation = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Level = table.Column<int>(type: "int", nullable: false),
                    TitleJp = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    TitleVi = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ContentJp = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ContentFurigana = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReadingArticles", x => x.ArticleId);
                    table.ForeignKey(
                        name: "FK_ReadingArticles_ReadingCategories_CatId",
                        column: x => x.CatId,
                        principalTable: "ReadingCategories",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    PaymentMethod = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "PayOS"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_ReferenceId_ReferenceType",
                table: "Questions",
                columns: new[] { "ReferenceId", "ReferenceType" });

            migrationBuilder.CreateIndex(
                name: "IX_ReadingArticles_CatId",
                table: "ReadingArticles",
                column: "CatId");

            migrationBuilder.CreateIndex(
                name: "IX_ReadingArticles_Level",
                table: "ReadingArticles",
                column: "Level");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProgresses_UserId_ReferenceId_ReferenceType",
                table: "UserProgresses",
