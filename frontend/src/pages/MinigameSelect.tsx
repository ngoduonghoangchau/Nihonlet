...
const MinigameSelect: React.FC = () => {
  ...
  // 1. Lấy danh sách bộ thẻ thực tế từ API
  useEffect(() => {
  ...
  // 2. Logic kiểm tra giới hạn (Max 3 bộ thẻ - GAME_001)
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
              ...
              <div className="flex gap-3 w-full md:w-auto">
                ...
                <div className="bg-white border border-[#f3e7ed] px-5 py-3 rounded-2xl flex items-center gap-4 shadow-sm">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[10px] uppercase font-bold text-[#9a4c73]/50">Selected</span>
