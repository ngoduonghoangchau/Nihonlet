...
import { ChevronLeft, ChevronRight, RefreshCw, Loader2, ArrowLeft, BookOpen } from "lucide-react";
  ...
  if (!deck || deck.cards.length === 0)
    return (
      <div className="h-screen flex flex-col items-center justify-center gap-4 text-center px-4">
        ...
        <button onClick={() => navigate("/dashboard")} className="text-primary font-bold underline">
          Quay lại thư viện
        </button>
      </div>
    );
        ...
        <div className="w-full mb-8">
          ...
          <div className="flex justify-between items-end mb-3">
            <div>
              ...
              <p className="text-[#9a4c73] font-medium text-xs sm:text-sm">
                Card {currentIndex + 1} of {deck.cards.length}
              </p>
            </div>
            <div className="text-right">
              <p className="text-primary font-black text-xs sm:text-sm mb-1 uppercase tracking-wider">
